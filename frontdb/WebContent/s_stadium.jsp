...
<% 
 ...
 rset = stmt.executeQuery("SELECT T.TID, S.SID, T.NAME, S.SNAME, S.CAPACITY FROM TEAMS T, STADIUM S WHERE T.SID=S.SID ORDER BY S.CAPACITY DESC"); 
...
<title>Statistics about Stadiums</title>
</head>
<body>
<!-- header -->
<div id="header">
...
<div id="content">
 ...
 <h2>Stadium Capacity Ranking</h2> 
 <TABLE> 
 <tr> 
 <td><h3>Name</h3></td><td><h3>Belong to</h3></td><td><h3>Capacity</h3></td> 
 </tr> 
