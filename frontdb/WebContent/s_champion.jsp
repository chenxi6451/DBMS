...
<% 
 ...
 rset = stmt.executeQuery("SELECT T.TID, T.NAME, COUNT(*) AS NUM_CHAMPION FROM TEAMS T, WIN W WHERE T.TID=W.TID GROUP BY T.TID, T.NAME ORDER BY COUNT(*) DESC"); 
 Statement stmt1 = conn.createStatement(); 
 rset1 = stmt1.executeQuery("SELECT T.TID, T.NAME, W.YEAR FROM TEAMS T, WIN W WHERE T.TID=W.TID ORDER BY W.YEAR"); 
...
<title>Statistics about Champion</title>
</head>
<body>
<!-- header -->
<div id="header">
...
<h2>Champion of Each Year</h2> 
 <TABLE> 
 <tr> 
 <td><h3>Year</h3></td><td><h3>Champion</h3></td> 
 </tr> 
...
<% 
 ...
 <tr><td style="width:200px"><%out.print(rset1.getInt("year")); %></td> 
 <td style="width:200px"><a href="clubpage.jsp?tid=<%=tid%>"> 
 <%out.print(rset1.getString("name"));  %> </a></td></tr>
 <%  
 } 
 } else { 
 out.print(error_msg); 
...
%>
 ...
 <TABLE> 
 <tr> 
 <td><h3>Team</h3></td><td><h3>Times of Winning Champions</h3></td> 
 </tr> 
...
<% 
 ...
 while(rset.next()) {
	 ...
	 <td style="width:200px"><%out.print(rset.getInt("num_champion")); %> 
	 </td></tr>
<%  
 } 
 } else { 
