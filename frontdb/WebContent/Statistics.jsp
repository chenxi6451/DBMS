...
<% 
 ...
 rset = stmt.executeQuery("SELECT P.NAME, P.GOAL FROM PLAYERS P WHERE P.GOAL>0 ORDER BY P.GOAL DESC"); 
 rset1 = stmt1.executeQuery("SELECT T.NAME, W.YEAR FROM TEAMS T, WIN W WHERE T.TID=W.TID ORDER BY W.YEAR"); 
...
<h2>Statistics</h2>
<ul>
<li><a href="s_champion.jsp" class="active">Statistics about Champions</a></li>
<li><a href="s_team.jsp" class="active">Statistics about Teams</a></li>
<li><a href="s_stadium.jsp" class="active">Statistics about Stadiums</a></li>
<li><a href="s_player.jsp" class="active">Statistics about Players</a></li>
<li><a href="s_position.jsp" class="active">Statistics about Positions</a></li>
</ul>
    </div>
<div id="right">
    <h2>Login</h2>
